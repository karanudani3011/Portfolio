...
const Projects = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            description: 'A Netflix-inspired streaming UI built with React, featuring movie browsing, responsive design, and smooth animations for a real OTT-like experience.',
            imageIcon: <Clapperboard size={48} className="text-softBlue-500" />,
            tags: ['Html', 'Css'],
            category: 'Web',
            githubLink: 'https://github.com/karanudani3011/netflix-clone',
            liveLink: null,
        }
